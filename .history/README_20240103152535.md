...
1. The Full module epochs too small, need to add to around 2000.
    ...
    Improvement: Set the epochs and learning goals based on fully connected result (learning goal: the train data max residual of full learning algorithm should be less than maximum residual of train dataof the best epoch in fully connected nets)
