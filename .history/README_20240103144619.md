...
3. Process | Full Path
    ...
    - Benchmark: simple two layer net (2 ~ 5), best loss and 

        |Train loss/Test loss/Best Epoch | Two layer net      | Three layer net | Four layer net |
        | ------------------------------ | ------------------ | --------------- | -------------- |
        | Copper                         |  6.648/836.299     |  37.60/1138.72  |                |
