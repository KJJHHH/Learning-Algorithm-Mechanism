...
1. The Full module epochs too small, need to add to around 2000.
    ...
    Improvement: Set the epochs and learning goals based on fully connected result (learning goal: the train data max residual of full learning algorithm should be less than maximum residual of train data of the best epoch in fully connected nets)
...
{
    "epoch": 3000,
    "lr_goal": 3.33 # squared residual of the top 30th residual of the benchmark two layer net
}
```
1. Epoch 3000, Learning goals 3.33 (the top 30th residual of the benchmark two layer net), learning
