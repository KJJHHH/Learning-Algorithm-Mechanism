...
1. The Full module epochs too small, need to add to around 2000\
    Improvement: Set the learning goals based on fully connected result (learning goal is the train data max residual of full learning algorithm should be less than maximum residual )
