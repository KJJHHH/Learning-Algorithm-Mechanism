...
def module_weight_EU_LG_UA(model, train_loader, test_loader, outfile
                        lr_rate,
                        lr_bound, 
                        lr_goal, 
                        criterion, 
    ...
    for epoch in range(epochs):
        gc.collect()
        out_file.write(f"--------- module_EU_LG Epoch {epoch} ---------", end = "\r")
        ...
        print("train_loss:", train_loss, end = "\r")
        ...
        if train_loss <= loss_old:
            print("Save model and lr increase", end = "\r")
            ...
            if optimizer.param_groups[0]['lr'] < lr_bound:
                ...
                print("Restore model and lr decrease", end = "\r")
