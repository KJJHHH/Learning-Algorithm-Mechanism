...
class reorganising():
    ...
    def trim_model_nodes(self, k):
        ...
        if False not in delete_status:
            self.out_file.write("Try trim model: Copy model and delete nodes success")
        else:
            self.out_file.write("Try trim model: Copy model and delete nodes error")
    ...
    def reorganising(self):
        ...
        self.out_file.write('=================== reorganising ===================')
        k = 1 
        check_n = 0
        while k<=self.hidden_dim:
            self.out_file.write(f"[{check_n/self.hidden_dim*100: .2f}%] ------------> Checking nodes...")
