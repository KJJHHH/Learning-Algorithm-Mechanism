...
class reorganising():
    ...
    def module_weight_EU_LG_UA(self, model):
        ...
        for epoch in range(self.epochs):
            ...
            if self.validate_run:
                preds, test_loss = validate_loss(model, self.test_loader, self.criterion)
    ...
    def regularising_EU_LG_UA(self):  
        ...
        for epoch in range(self.epochs):
            ...
            # Validate
            if self.validate_run:
                preds, test_loss = validate_loss(self.model, self.test_loader, self.criterion)
                test_loss_list.append(test_loss)
    ...
    def reorganising(self):
        ...
        while k<=self.hidden_dim:
            ...
            acceptable, eps, y_pred = check_acceptable(self.train_loader, self.model, self.lr_goal)
            loss_reg = validate_loss(self.model, self.train_loader)
